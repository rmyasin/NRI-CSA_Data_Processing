...
coverageCategory = [repmat({'Unaided'},length([arteryMetrics(:,1).coverage]),1);
                    ...
                    repmat({'Bilateral'},length([arteryMetrics(:,3).coverage]),1);
                    repmat({'FRMM'},length([arteryMetrics(:,4).coverage]),1)];
...
distProjCategory = [repmat({'Unaided'},length([arteryMetrics(:,1).meanProjDistance]),1);
                    ...
                    repmat({'Bilateral'},length([arteryMetrics(:,3).meanProjDistance]),1);
                    repmat({'FRMM'},length([arteryMetrics(:,4).meanProjDistance]),1)];
...
forceCategory = [repmat({'Unaided'},length([arteryMetrics(:,1).forceError]),1);
                    ...
                    repmat({'Bilateral'},length([arteryMetrics(:,3).forceError]),1);
                    repmat({'FRMM'},length([arteryMetrics(:,4).forceError]),1)];
...
timeCategory = [repmat({'Unaided'},length([arteryMetrics(:,1).completionTime]),1);
                    ...
                    repmat({'Bilateral'},length([arteryMetrics(:,3).completionTime]),1);
                    repmat({'FRMM'},length([arteryMetrics(:,4).completionTime]),1)];
...
expNames={'Unaided','Visual','Bilateral','FRMM'};
figure
